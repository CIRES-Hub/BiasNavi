...
class FairnessScorer:
    ...
    def distribution_score(
        ...
        Args:
            metric (str, optional):
                Choose a bias to use. Defaults to automatically chosen bias depending on
                the distribution of the target variable.
            method (str, optional):
                The method used to apply the bias to the sub-group. Can take values
    ...
    def demographic_report(
        ...
        Args:
            metric (str, optional):
                Choose a custom bias to use. Defaults to automatically chosen bias depending on
