...
class CustomizedPythonAstREPLTool(PythonAstREPLTool):
    ...
    def add_figure(self, processed_item: Figure):
        ...
        self.elem_queue.append(dbc.Modal([
            ...
            dbc.ModalFooter()
        ], id={"type": "llm-media-modal", "index": current_id}, centered=True, className="figure-modal"))
            ...
            try:
                ...
                try:
                    with redirect_stdout(io_buffer):
                        processed_item = eval(module_end_str.replace('.show()', ''), self.globals, self.locals)
                        if (isinstance(processed_item, DataFrame)):
                            ...
                            raise NotImplementedError("The LLM returned an unsupported media type.")
